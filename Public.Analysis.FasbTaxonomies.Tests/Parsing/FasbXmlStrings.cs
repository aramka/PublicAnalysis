...
namespace Public.Analysis.FasbTaxonomies.Tests.Parsing
{
    ...
    {
        public static string roleUri = @"http://fasb.org/us-gaap/role/statement/StatementOfCashFlowsIndirectDepositBasedOperations";
        ...
        public static readonly string statementDocXmlString = $@"
            <link:linkbase xmlns:link='http://www.xbrl.org/2003/linkbase' xmlns:xlink='http://www.w3.org/1999/xlink' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance' xsi:schemaLocation='http://www.xbrl.org/2003/linkbase http://www.xbrl.org/2003/xbrl-linkbase-2003-12-31.xsd'>
                <link:roleRef roleURI='{roleUri}' xlink:href='{roleXLinkHRef}' xlink:type='{roleXLinkType}'/>
            </link:linkbase>
        ";
        ...
        public static Dictionary<string,XNamespace> NameSpacesByElementName => statementDoc.Root!.Attributes().Where(a => a.IsNamespaceDeclaration).ToDictionary(a => a.Name.LocalName, a => (XNamespace)a.Value);


        public static XElement RoleRefElement => new XElement(statementDoc.Descendants(NameSpacesByElementName["link"] + "roleRef").Single());
    }
}
